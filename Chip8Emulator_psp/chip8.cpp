...
void chip8::emulateCycle()
{
	...
	case 0x0000://0x00XX
		...
		case 0x0000: // 0x00E0: Clears the screen        
			for (unsigned char * i = gfx + 64 * 32; i-- ;)
			{
		...
		case 0x000E://return from a subroutine
			...
			break;
		default:
			pspDebugScreenPrintf("Unknown opcode [0x0000]: 0x%X\n", opcode);
			break;
		}
		break;
	case 0x1000://JP addr
	...
	case 0x8000:
		...
		case 0x000E://SHL Vx {, Vy}
			...
			*/
			...
			break;
		default:
			pspDebugScreenPrintf("Unknown opcode [0x8000]: 0x%X\n", opcode);
			break;
		}
		break;
	...
	case 0xE000:
		...
		case 0x00A1:
			...
			break;
		default:
			pspDebugScreenPrintf("Unknown opcode 0xE000 : 0x%X\n", opcode);
			break;
		}
		break;
	case 0xF000:
		...
		case 0x0065:
			...
			*/
			...
			break;
		default:
			pspDebugScreenPrintf("Unknown opcode 0xF000 : 0x%X\n", opcode);
			break;
		}
		break;
	default:
		pspDebugScreenPrintf("Unknown opcode: 0x%X\n", opcode);
		break;
	}
...
void chip8::loadGame(char * game_file)
{
	...
	if (!pFile)
	{
		pspDebugScreenPrintf("Error, game file could not be loaded !\n");
		return;
	}
...
void chip8::Dissasemble(char * file_name)
{
	...
	if (!pFile)
	{
		pspDebugScreenPrintf("Error, asm file could not be created !\n");
	}
	...
	{
		char buffer[20] = "";
		pspDebugScreenPrintf(buffer, "%d", (opcode & 0x0FFF));
...
void chip8::Compile(char * file_name)
{
	...
	// if (!pFile)
	// {
	// 	pspDebugScreenPrintf("Error, ch8 file could not be created !\n");
	// }
